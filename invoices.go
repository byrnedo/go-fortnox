...
// InvoiceQueryParams when searching orders/invoices
// From fortnox docs:
...
func (p InvoiceQueryParams) toValues() url.Values {
...
func (c *Client) ListInvoices(ctx context.Context, p *InvoiceQueryParams) (*ListInvoicesResp, error) {
